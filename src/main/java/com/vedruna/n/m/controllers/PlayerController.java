...
public class PlayerController {
    ...
    @PutMapping("/darTrofeo/{idPlayer}/trophies/{idTrophie}")
    public ResponseEntity<Void> giveTrophieToPlayer(@PathVariable int idPlayer, @PathVariable int idTrophie) {
        playerMngmnt.giveTrophieToPlayer(idPlayer, idTrophie);
